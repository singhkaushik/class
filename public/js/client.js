...
function shareRoomByEmail() {
    Swal.fire({
        ...
        preConfirm: () => {
            ...
            const email = '';
            const emailSubject = `Please join our Live Class Video Chat Meeting`;
    ...
    Swal.fire({
        ...
        <div id="about">
            ...
            Email:<a 
                ...
                href="mailto:doxytest@gmail.com?subject=Live Class info"> 
                doxytest@gmail.com
            </a>
        </div>
        `,
...
function leaveFeedback() {
    Swal.fire({
        ...
        text: 'Do you want to rate your Live Class experience?',
        confirmButtonText: `Yes`,
        denyButtonText: `No`,
        showClass: { popup: 'animate__animated animate__fadeInDown' },
        hideClass: { popup: 'animate__animated animate__fadeOutUp' },
